...
class ProductNotesControllerTest < ActionController::TestCase
  ...
  test "should create product_note" do
    assert_difference('ProductNote.count') do
      post :create, product_note: { content: @product_note.content, isprivate: @product_note.isprivate, product_id: @product_note.product_id, user_id: @product_note.user_id }
    end
  ...
  test "should update product_note" do
    patch :update, id: @product_note, product_note: { content: @product_note.content, isprivate: @product_note.isprivate, product_id: @product_note.product_id, user_id: @product_note.user_id }
    assert_redirected_to product_note_path(assigns(:product_note))
  end
