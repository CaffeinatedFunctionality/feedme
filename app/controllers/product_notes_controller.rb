class ProductNotesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @product_note.save
        format.html { redirect_to @product_note, notice: 'Product note was successfully created.' }
  ...
  private
    ...
    def product_note_params
      params.require(:product_note).permit(:product_id, :isprivate, :user_id, :content)
    end
end
